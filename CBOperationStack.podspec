Pod::Spec.new do |s|
  ...
  s.description = "A LIFO implementation of Apple's NSOperationQueue. It has the same interface as NSOperationQueue, with the addition of one method, addOperationAtBottomOfStack:(NSOperation*)op, which effectively allows you to use it as you would NSOperationQueue."
